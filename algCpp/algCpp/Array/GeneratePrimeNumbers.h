...
namespace  GeneratePrimeNumbersNM //@RED20170722012
{
	...
	Finding prime numbers_20170722012
		Prime number is a number that is divisible ONLY by itself and nothing else can divide it.
		This means 2 is prime but the multiple of 2 are not prime because those number are divisible by 2.
		So logic mark 2 as prime and all its multiples(4,6) as non-prime.
		Similarly mark 3 as prime and all it multiples as non-prime. 
		
		any number generated by  
